public class Move {
	...
	public void setOldPosition(Position oldPos) {
		this.oldPos = oldPos;
	}
	...
	// check if the old position and the new position is connected (adjacent)
	public boolean isConnected() {
		if (isValidPosition() && (isConnectedColume() || isConnectedRow() || isConnectedDiagonal()))	{
			return true;
		}
		return false;
	}
